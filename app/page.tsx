...
export default function Home() {
    ...
    if (draggableEl) {
      new Draggable(draggableEl, {
        ...
        eventData: function (eventEl) {
          ...
          return { title, id, start, description }
        }
      })
    }
  }, [])
  ...
  const handleDesciptionChange = (e: React.ChangeEvent<HTMLInputElement>): void => {
    setNewEvent({
      ...newEvent,
                      ...
                      <div className="mt-3 text-center sm:mt-5">
                        ...
                        <form action="submit" onSubmit={handleSubmit}>
                          ...
                          <div className="mt-2">
                            ...
                            focus:ring-inset focus:ring-violet-600 
                            sm:text-sm sm:leading-6"
                              value={newEvent.description} onChange={(e) => handleDesciptionChange(e)} placeholder="Description" />
                          </div>
